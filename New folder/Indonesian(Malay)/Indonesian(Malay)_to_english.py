...
class IndonesianToEnglishGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("🇮🇩 Indonesian → English Translator")
        self.root.geometry("950x650")
        self.root.configure(bg="#1a1a2e")

        # Local model path (existing Indonesian → English model)
        self.model_path = r"C:\Users\intel\models\opus-mt-id-en"
        self.model = None
        self.tokenizer = None
    ...
    def build_gui(self):
        # Header
        self.header = tk.Label(self.root, text="🇮🇩 Indonesian → English Translator",
        ...
        self.input_label = tk.Label(self.input_frame, text="Enter Indonesian Text or Paste Content:",
...
if __name__ == "__main__":
    root = tk.Tk()
    app = IndonesianToEnglishGUI(root)
    root.mainloop()
