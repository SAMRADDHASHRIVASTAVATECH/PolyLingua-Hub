...
class EnglishToChineseGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("🇬🇧 English → Mandarin Chinese Translator")
        self.root.geometry("950x650")
        self.root.configure(bg="#1a1a2e")

        # Local model path
        self.model_path = r"C:\Users\intel\models\opus-mt-en-zh"
        self.model = None
        self.tokenizer = None
    ...
    def build_gui(self):
        # Header
        self.header = tk.Label(self.root, text="🇬🇧 English → Mandarin Chinese Translator",
        ...
        self.output_label = tk.Label(self.output_frame, text="Mandarin Chinese Translation:",
                                     bg="#1f4068", fg="#e0e0e0", font=("Helvetica", 12, "bold"))
