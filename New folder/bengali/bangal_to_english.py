...
class BengaliTranslatorGUI:
    def __init__(self, root, main_menu_callback=None):
        """
        main_menu_callback: a function to call when Back to Main Menu is clicked
        """
        self.root = root
        self.main_menu_callback = main_menu_callback  # store callback
        self.root.title("🇧🇩 Bengali → English Translator")
        self.root.geometry("950x650")
        self.root.configure(bg="#1a1a2e")

        # Local model path
        self.model_path = r"C:\Users\intel\models\Helsinki-NLP_opus-mt-bn-en"
        self.model = None
        self.tokenizer = None
    ...
    def build_gui(self):
        # Header
        self.header = tk.Label(self.root, text="🇧🇩 Bengali → English Translator",
        ...
        self.input_label = tk.Label(self.input_frame, text="Enter Bengali Text or Paste Content:",
        ...
        self.back_btn = tk.Button(self.button_frame, text="Back to Main Menu", bg="#0f3460", fg="white",
                                  font=("Helvetica", 12, "bold"), relief="flat", padx=25, pady=10,
    ...
    def back_to_main(self):
        ...
        if self.main_menu_callback:
            ...
            self.main_menu_callback()  # open main menu
        else:
            self.root.destroy()  # just close window if no callback


if __name__ == "__main__":
    # Example usage: standalone
    def dummy_main_menu():
        messagebox.showinfo("Main Menu", "Back to main menu called!")

    root = tk.Tk()
    app = BengaliTranslatorGUI(root, main_menu_callback=dummy_main_menu)
    root.mainloop()
