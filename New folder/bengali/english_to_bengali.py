...
# ---------------- Configuration ----------------
MODEL_NAME = "shhossain/opus-mt-en-to-bn"   # English -> Bengali
MODEL_DIR = r"C:\Users\intel\models\opus-mt-en-to-bn"
...
# ---------------- GUI Build ----------------
root = tk.Tk()
root.title("English → Bengali Translator")
root.geometry("950x650")
root.configure(bg="#1a1a2e")

# Header
header = tk.Label(root, text="🇬🇧 English → Bengali Translator",
...
tk.Label(output_frame, text="Bengali Translation:",
         bg="#1f4068", fg="#e0e0e0", font=("Helvetica", 12, "bold")).pack(anchor="w", padx=8, pady=(6, 0))
