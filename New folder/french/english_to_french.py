...
MODEL_DIR = r"C:\Users\intel\models\opus-mt-en-fr"
...
# ---------------- GUI Build ----------------
root = tk.Tk()
root.title("English → French Translator")
root.geometry("950x650")
root.configure(bg="#1a1a2e")

# Header
header = tk.Label(root, text="🇬🇧 English → French Translator",
...
tk.Label(output_frame, text="French Translation:",
         bg="#1f4068", fg="#e0e0e0", font=("Helvetica", 12, "bold")).pack(anchor="w", padx=8, pady=(6, 0))
