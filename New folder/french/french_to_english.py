...
class FrenchToEnglishGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("🇫🇷 French → English Translator")
        self.root.geometry("950x650")
        self.root.configure(bg="#1a1a2e")

        # Local model path (existing French → English model)
        self.model_path = r"C:\Users\intel\models\opus-mt-fr-en"
        self.model = None
        self.tokenizer = None
    ...
    def build_gui(self):
        # Header
        self.header = tk.Label(self.root, text="🇫🇷 French → English Translator",
        ...
        self.input_label = tk.Label(self.input_frame, text="Enter French Text or Paste Content:",
