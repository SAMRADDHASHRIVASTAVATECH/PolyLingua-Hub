...
class JapaneseToEnglishGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("🌸 Japanese → English Translator")
        self.root.geometry("950x650")
        self.root.configure(bg="#1a1a2e")

        # Local model path (existing model you already have)
        self.model_path = r"C:\Users\intel\models\opus-mt-ja-en"
        self.model = None
        self.tokenizer = None
    ...
    def build_gui(self):
        # Header
        self.header = tk.Label(self.root, text="🌸 Japanese → English Translator",
        ...
        self.input_label = tk.Label(self.input_frame, text="Enter Japanese Text or Paste Content:",
    ...
    def load_model_async(self):
        def load_model():
            try:
                ...
                # fallback: try downloading (if model missing)
