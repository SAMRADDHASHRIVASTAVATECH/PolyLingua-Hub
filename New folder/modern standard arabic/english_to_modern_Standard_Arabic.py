...
class EnglishToArabicGUI:
    def __init__(self, root):
        ...
        # Local model path (existing English → Arabic model)
        self.model_path = r"C:\Users\intel\models\opus-mt-en-ar"
        self.model = None
        self.tokenizer = None
    ...
    def build_gui(self):
        # Header
        self.header = tk.Label(self.root, text="🇬🇧 English → Arabic Translator",
        ...
        self.output_label = tk.Label(self.output_frame, text="Arabic Translation:",
                                     bg="#1f4068", fg="#e0e0e0", font=("Helvetica", 12, "bold"))
    ...
    # Translation preserving paragraph breaks
